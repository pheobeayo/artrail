        ...
        <main className="bg-[#231D16]">
            ...
            <section className='lg:w-[80%] md:w-[80%] w-[100%] mx-auto py-12 px-4 lg:px-0 md:px-0 flex lg:flex-row md:flex-row flex-col justify-between'>
                ...
                <div className='text-white lg:w-[60%] md:w-[60%] w-[100%] p-4 border bg-[#231D16]/90 border-white rounded-2xl'>
                    ...
                    <p className='flex gap-12 my-4 font-titiliumweb mb-4 font-bold text-white lg:text-[24px] md:text-[24px] text-[20px]'>0.5 ETH <span>5 units </span><span>5 units</span></p>
                    <p className='flex gap-20 my-4 text-[#54BE73] lg:text-[18px] md:text-[18px] text-[14px]'>Price <span>Qty left</span><span>Qty bought</span></p>
